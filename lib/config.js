...
export const CONFIG_PATH = join(homedir(), `.autopush.json`);
...
export function loadConfig() {
	try {
		...
		throw new Error(`Config file not found at ${CONFIG_PATH}\nRun "autopush init" to create one.`);
	}
...
export function createDefaultConfig() {
	...
	logger.info(`Edit it to add your server profiles, then run autopush --profile <name>`);
}
