...
export const logger = {
	...
	upload(file, host, remote_path) {
		console.log(`${prefix(colors.green, `↑`)} ${colors.bold}${file}${colors.reset} ${colors.dim}→${colors.reset} ${colors.cyan}${host}${colors.reset}${colors.dim}:${remote_path}${colors.reset}`);
	},
